...
<!---->
<!--    <title>Blog for SoftGroup</title>-->
<!---->
<!--    <!-- Bootstrap -->-->
...
<!--      <div class="container">-->
<!--        <a class="navbar-brand" href="home.php">Blog for SoftGroup</a>-->
...
<!--            </li>-->
<!--            <li class="nav-item">-->
<!--              <a class="nav-link" href="news.html">Registration</a>-->
<!--            </li>-->
<!--            <li class="nav-item">-->
<!--              <a class="nav-link" href="news.html">Log in</a>-->
<!--            </li>-->
<!--          </ul>-->
<!--        </div>-->
<!--      </div>-->

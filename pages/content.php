...
<div class="container">
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide" style="background: url('<?php echo $art['image']; ?>');background-repeat: no-repeat;background-position: center;">
                <h4 class="title-article"><a href="../article.php?id=<?php echo $art['id']; ?>"><?php echo $art['title']; ?></a></h4>
                <div class="title-article-data" style="display: none">
